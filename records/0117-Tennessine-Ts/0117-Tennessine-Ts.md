...
|---|---|---|---|
| Canonical name | Tennessine | | IUPAC |
| Symbol | Ts | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 117 | | IUPAC |
...
Tennessine (Ts, Z = 117) is a halogen in period 7, group 17 of the periodic table.
...
Electronic configuration: **[Rn]7s2 7p5 5f14 6d10 (predicted)** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 7p5 5f14 6d10 (predicted) | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
