...
|---|---|---|---|
| Canonical name | Cadmium | | IUPAC |
| Symbol | Cd | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 48 | | IUPAC |
| Standard atomic weight | 112.414(4) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 12 | | IUPAC |
| Block | d | | IUPAC |
...
Cadmium (Cd, Z = 48) is a transition metal in period 5, group 12 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d10** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 112.414(4) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 4d10 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.69 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 8.994 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 594.22 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1040 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 8.69 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
