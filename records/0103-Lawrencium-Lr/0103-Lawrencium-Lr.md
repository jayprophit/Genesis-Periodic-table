...
|---|---|---|---|
| Canonical name | Lawrencium | | IUPAC |
| Symbol | Lr | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 103 | | IUPAC |
...
Lawrencium (Lr, Z = 103) is a transition metal in period 7, group 3 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d1** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
...
| meltingPoint | 1900 | K | See source | REPORTED | PUBCHEM-PERIODIC |
