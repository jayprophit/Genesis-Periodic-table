...
|---|---|---|---|
| Canonical name | Erbium | | IUPAC |
| Symbol | Er | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 68 | | IUPAC |
| Standard atomic weight | 167.259(3) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | f | | IUPAC |
...
Erbium (Er, Z = 68) is a lanthanide in period 6, group 3 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f12** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 167.259(3) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f12 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.24 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
...
| meltingPoint | 1802 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3141 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 9.07 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
