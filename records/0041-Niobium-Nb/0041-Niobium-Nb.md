...
|---|---|---|---|
| Canonical name | Niobium | | IUPAC |
| Symbol | Nb | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 41 | | IUPAC |
| Standard atomic weight | 92.90637(1) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 5 | | IUPAC |
| Block | d | | IUPAC |
...
Niobium (Nb, Z = 41) is a transition metal in period 5, group 5 of the periodic table.
...
Electronic configuration: **[Kr]5s1 4d4** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 92.90637(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s1 4d4 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.6 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.759 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2750 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 5017 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 8.57 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
