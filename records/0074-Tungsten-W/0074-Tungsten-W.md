...
|---|---|---|---|
| Canonical name | Tungsten | | IUPAC |
| Symbol | W | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 74 | | IUPAC |
| Standard atomic weight | 183.84(1) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 6 | | IUPAC |
| Block | d | | IUPAC |
...
Tungsten (W, Z = 74) is a transition metal in period 6, group 6 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d4** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 183.84(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d4 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.36 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.98 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 3695 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 5828 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 19.3 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +6 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
