...
|---|---|---|---|
| Canonical name | Francium | | IUPAC |
| Symbol | Fr | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 87 | | IUPAC |
...
Francium (Fr, Z = 87) is a alkali metal in period 7, group 1 of the periodic table.
...
Electronic configuration: **[Rn]7s1** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 0.7 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 3.9 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 300 | K | See source | REPORTED | PUBCHEM-PERIODIC |
