...
|---|---|---|---|
| Canonical name | Zinc | | IUPAC |
| Symbol | Zn | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 30 | | IUPAC |
| Standard atomic weight | 65.38(2) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 12 | | IUPAC |
| Block | d | | IUPAC |
...
Zinc (Zn, Z = 30) is a transition metal in period 4, group 12 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d10** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 65.38(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d10 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.65 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 9.394 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 692.68 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1180 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 7.134 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
