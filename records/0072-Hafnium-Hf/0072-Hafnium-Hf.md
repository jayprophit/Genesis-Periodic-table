...
|---|---|---|---|
| Canonical name | Hafnium | | IUPAC |
| Symbol | Hf | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 72 | | IUPAC |
| Standard atomic weight | 178.486(6) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 4 | | IUPAC |
| Block | d | | IUPAC |
...
Hafnium (Hf, Z = 72) is a transition metal in period 6, group 4 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 178.486(6) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.3 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.825 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2506 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 4876 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 13.3 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
