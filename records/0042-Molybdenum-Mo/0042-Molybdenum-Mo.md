...
|---|---|---|---|
| Canonical name | Molybdenum | | IUPAC |
| Symbol | Mo | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 42 | | IUPAC |
| Standard atomic weight | 95.95(1) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 6 | | IUPAC |
| Block | d | | IUPAC |
...
Molybdenum (Mo, Z = 42) is a transition metal in period 5, group 6 of the periodic table.
...
Electronic configuration: **[Kr]5s1 4d5** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 95.95(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s1 4d5 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.16 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.092 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2896 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 4912 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 10.2 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
