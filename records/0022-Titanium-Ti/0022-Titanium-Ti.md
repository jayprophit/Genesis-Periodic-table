...
|---|---|---|---|
| Canonical name | Titanium | | IUPAC |
| Symbol | Ti | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 22 | | IUPAC |
| Standard atomic weight | 47.867(1) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 4 | | IUPAC |
| Block | d | | IUPAC |
...
Titanium (Ti, Z = 22) is a transition metal in period 4, group 4 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 47.867(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.54 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.828 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1941 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3560 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 4.5 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +4, +3, +2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
