...
|---|---|---|---|
| Canonical name | Dubnium | | IUPAC |
| Symbol | Db | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 105 | | IUPAC |
...
Dubnium (Db, Z = 105) is a transition metal in period 7, group 5 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d3** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d3 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
...
| oxidationStates | 5, 4, 3 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
