...
|---|---|---|---|
| Canonical name | Tantalum | | IUPAC |
| Symbol | Ta | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 73 | | IUPAC |
| Standard atomic weight | 180.94788(2) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 5 | | IUPAC |
| Block | d | | IUPAC |
...
Tantalum (Ta, Z = 73) is a transition metal in period 6, group 5 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d3** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 180.94788(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d3 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.5 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.89 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 3290 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 5731 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 16.4 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +5 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
