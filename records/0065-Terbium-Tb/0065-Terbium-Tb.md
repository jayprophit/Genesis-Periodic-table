...
|---|---|---|---|
| Canonical name | Terbium | | IUPAC |
| Symbol | Tb | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 65 | | IUPAC |
| Standard atomic weight | 158.925354(7) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | f | | IUPAC |
...
Terbium (Tb, Z = 65) is a lanthanide in period 6, group 3 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f9** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 158.925354(7) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f9 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | UNAVAILABLE | Pauling | See source | UNAVAILABLE | UNAVAILABLE |
| firstIonizationEnergy | 5.864 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1629 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3503 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 8.23 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
