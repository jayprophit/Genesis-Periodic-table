...
|---|---|---|---|
| Canonical name | Einsteinium | | IUPAC |
| Symbol | Es | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 99 | | IUPAC |
...
Einsteinium (Es, Z = 99) is a actinide in period 7, group 3 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f11** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f11 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.3 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.42 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1133 | K | See source | REPORTED | PUBCHEM-PERIODIC |
