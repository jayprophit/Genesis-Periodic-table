...
|---|---|---|---|
| Canonical name | Thallium | | IUPAC |
| Symbol | Tl | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 81 | | IUPAC |
| Standard atomic weight | [204.382,204.385] | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 13 | | IUPAC |
| Block | p | | IUPAC |
...
Thallium (Tl, Z = 81) is a post-transition metal in period 6, group 13 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d10 6p1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | [204.382,204.385] | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d10 6p1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.62 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.108 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 577 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1746 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 11.8 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +3, +1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
