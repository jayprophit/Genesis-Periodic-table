...
|---|---|---|---|
| Canonical name | Magnesium | | IUPAC |
| Symbol | Mg | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 12 | | IUPAC |
| Standard atomic weight | [24.304,24.307] | EVALUATED | CIAAW-2024 |
| Period | 3 | | IUPAC |
| Group | 2 | | IUPAC |
| Block | s | | IUPAC |
...
Magnesium (Mg, Z = 12) is a alkaline earth metal in period 3, group 2 of the periodic table.
...
Electronic configuration: **[Ne]3s2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | [24.304,24.307] | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ne]3s2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.31 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.646 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 923 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1363 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 1.74 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
