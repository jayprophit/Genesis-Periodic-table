...
|---|---|---|---|
| Canonical name | Strontium | | IUPAC |
| Symbol | Sr | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 38 | | IUPAC |
| Standard atomic weight | 87.62(1) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 2 | | IUPAC |
| Block | s | | IUPAC |
| Category | Alkaline Earth Metal | | IUPAC |

---

# 2. Executive Scientific Summary

Strontium (Sr, Z = 38) is a alkaline earth metal in period 5, group 2 of the periodic table.
...
Electronic configuration: **[Kr]5s2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 87.62(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 0.95 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 5.695 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1050 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1655 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 2.64 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
