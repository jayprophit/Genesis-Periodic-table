...
|---|---|---|---|
| Canonical name | Iron | | IUPAC |
| Symbol | Fe | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 26 | | IUPAC |
| Standard atomic weight | 55.845(2) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 8 | | IUPAC |
| Block | d | | IUPAC |
...
Iron (Fe, Z = 26) is a transition metal in period 4, group 8 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d6** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 55.845(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d6 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.83 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.902 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1811 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3134 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 7.874 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
