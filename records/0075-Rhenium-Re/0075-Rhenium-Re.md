...
|---|---|---|---|
| Canonical name | Rhenium | | IUPAC |
| Symbol | Re | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 75 | | IUPAC |
| Standard atomic weight | 186.207(1) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 7 | | IUPAC |
| Block | d | | IUPAC |
...
Rhenium (Re, Z = 75) is a transition metal in period 6, group 7 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d5** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 186.207(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d5 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.9 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.88 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 3459 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 5869 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 20.8 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
