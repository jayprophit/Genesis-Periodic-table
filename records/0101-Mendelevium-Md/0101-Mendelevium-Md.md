...
|---|---|---|---|
| Canonical name | Mendelevium | | IUPAC |
| Symbol | Md | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 101 | | IUPAC |
...
Mendelevium (Md, Z = 101) is a actinide in period 7, group 3 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f13** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f13 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.3 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.58 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1100 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | UNAVAILABLE | K | See source | UNAVAILABLE | UNAVAILABLE |
| density | UNAVAILABLE | g/cm3 | Source reference conditions; consult element page | UNAVAILABLE | UNAVAILABLE |
