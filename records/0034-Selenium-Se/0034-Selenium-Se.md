...
|---|---|---|---|
| Canonical name | Selenium | | IUPAC |
| Symbol | Se | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 34 | | IUPAC |
| Standard atomic weight | 78.971(8) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 16 | | IUPAC |
| Block | p | | IUPAC |
...
Selenium (Se, Z = 34) is a reactive nonmetal in period 4, group 16 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d10 4p4** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 78.971(8) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d10 4p4 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.55 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 9.752 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 493.65 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 958 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 4.809 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +6, +4, -2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
