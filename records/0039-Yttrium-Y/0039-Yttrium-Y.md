...
|---|---|---|---|
| Canonical name | Yttrium | | IUPAC |
| Symbol | Y | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 39 | | IUPAC |
| Standard atomic weight | 88.905838(2) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | d | | IUPAC |
...
Yttrium (Y, Z = 39) is a transition metal in period 5, group 3 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 88.905838(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 4d1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.22 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.217 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1795 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3618 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 4.47 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
