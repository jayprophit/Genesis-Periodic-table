...
|---|---|---|---|
| Canonical name | Rhodium | | IUPAC |
| Symbol | Rh | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 45 | | IUPAC |
| Standard atomic weight | 102.90549(2) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 9 | | IUPAC |
| Block | d | | IUPAC |
...
Rhodium (Rh, Z = 45) is a transition metal in period 5, group 9 of the periodic table.
...
Electronic configuration: **[Kr]5s1 4d8** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 102.90549(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s1 4d8 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.28 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.459 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2237 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3968 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 12.4 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
