...
|---|---|---|---|
| Canonical name | Xenon | | IUPAC |
| Symbol | Xe | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 54 | | IUPAC |
| Standard atomic weight | 131.293(6) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 18 | | IUPAC |
| Block | p | | IUPAC |
...
Xenon (Xe, Z = 54) is a noble gas in period 5, group 18 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d10 5p6** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 131.293(6) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 4d10 5p6 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.6 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 12.13 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Gas | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 161.36 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 165.03 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 0.005887 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
