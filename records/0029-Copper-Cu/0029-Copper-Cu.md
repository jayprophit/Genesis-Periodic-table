...
|---|---|---|---|
| Canonical name | Copper | | IUPAC |
| Symbol | Cu | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 29 | | IUPAC |
| Standard atomic weight | 63.546(3) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 11 | | IUPAC |
| Block | d | | IUPAC |
...
Copper (Cu, Z = 29) is a transition metal in period 4, group 11 of the periodic table.
...
Electronic configuration: **[Ar]4s1 3d10** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 63.546(3) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s1 3d10 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.9 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.726 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1357.77 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 2835 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 8.933 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
