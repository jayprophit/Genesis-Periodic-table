...
|---|---|---|---|
| Canonical name | Ruthenium | | IUPAC |
| Symbol | Ru | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 44 | | IUPAC |
| Standard atomic weight | 101.07(2) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 8 | | IUPAC |
| Block | d | | IUPAC |
...
Ruthenium (Ru, Z = 44) is a transition metal in period 5, group 8 of the periodic table.
...
Electronic configuration: **[Kr]5s1 4d7** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 101.07(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s1 4d7 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.2 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.361 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2607 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 4423 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 12.1 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
