...
|---|---|---|---|
| Canonical name | Zirconium | | IUPAC |
| Symbol | Zr | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 40 | | IUPAC |
| Standard atomic weight | 91.222(3) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 4 | | IUPAC |
| Block | d | | IUPAC |
...
Zirconium (Zr, Z = 40) is a transition metal in period 5, group 4 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 91.222(3) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 4d2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.33 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.634 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2128 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 4682 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 6.52 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +4 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
