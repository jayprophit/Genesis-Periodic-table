...
|---|---|---|---|
| Canonical name | Lead | | IUPAC |
| Symbol | Pb | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 82 | | IUPAC |
| Standard atomic weight | [206.14,207.94] | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 14 | | IUPAC |
| Block | p | | IUPAC |
...
Lead (Pb, Z = 82) is a post-transition metal in period 6, group 14 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d10 6p2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | [206.14,207.94] | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d10 6p2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.33 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.417 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 600.61 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 2022 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 11.342 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
