...
|---|---|---|---|
| Canonical name | Potassium | | IUPAC |
| Symbol | K | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 19 | | IUPAC |
| Standard atomic weight | 39.0983(1) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 1 | | IUPAC |
| Block | s | | IUPAC |
| Category | Alkali Metal | | IUPAC |

---

# 2. Executive Scientific Summary

Potassium (K, Z = 19) is a alkali metal in period 4, group 1 of the periodic table.
...
Electronic configuration: **[Ar]4s1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 39.0983(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 0.82 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 4.341 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 336.53 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1032 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 0.89 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
