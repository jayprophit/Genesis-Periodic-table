...
|---|---|---|---|
| Canonical name | Indium | | IUPAC |
| Symbol | In | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 49 | | IUPAC |
| Standard atomic weight | 114.818(1) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 13 | | IUPAC |
| Block | p | | IUPAC |
...
Indium (In, Z = 49) is a post-transition metal in period 5, group 13 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d10 5p1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 114.818(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 4d10 5p1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.78 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 5.786 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 429.75 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 2345 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 7.31 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
