...
|---|---|---|---|
| Canonical name | Neon | | IUPAC |
| Symbol | Ne | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 10 | | IUPAC |
| Standard atomic weight | 20.1797(6) | EVALUATED | CIAAW-2024 |
| Period | 2 | | IUPAC |
| Group | 18 | | IUPAC |
| Block | p | | IUPAC |
...
Neon (Ne, Z = 10) is a noble gas in period 2, group 18 of the periodic table.
...
Electronic configuration: **[He]2s2 2p6** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 20.1797(6) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [He]2s2 2p6 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | UNAVAILABLE | Pauling | See source | UNAVAILABLE | UNAVAILABLE |
| firstIonizationEnergy | 21.565 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Gas | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 24.56 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 27.07 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 0.0008999 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
