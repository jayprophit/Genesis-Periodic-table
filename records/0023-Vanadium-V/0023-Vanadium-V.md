...
|---|---|---|---|
| Canonical name | Vanadium | | IUPAC |
| Symbol | V | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 23 | | IUPAC |
| Standard atomic weight | 50.9415(1) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 5 | | IUPAC |
| Block | d | | IUPAC |
...
Vanadium (V, Z = 23) is a transition metal in period 4, group 5 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d3** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 50.9415(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d3 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.63 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.746 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2183 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3680 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 6 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +5, +4, +3, +2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
