...
|---|---|---|---|
| Canonical name | Californium | | IUPAC |
| Symbol | Cf | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 98 | | IUPAC |
...
Californium (Cf, Z = 98) is a actinide in period 7, group 3 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f10** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f10 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.3 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.3 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1173 | K | See source | REPORTED | PUBCHEM-PERIODIC |
