...
|---|---|---|---|
| Canonical name | Scandium | | IUPAC |
| Symbol | Sc | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 21 | | IUPAC |
| Standard atomic weight | 44.955907(4) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | d | | IUPAC |
...
Scandium (Sc, Z = 21) is a transition metal in period 4, group 3 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 44.955907(4) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.36 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.561 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1814 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3109 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 2.99 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
