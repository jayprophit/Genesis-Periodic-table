...
|---|---|---|---|
| Canonical name | Europium | | IUPAC |
| Symbol | Eu | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 63 | | IUPAC |
| Standard atomic weight | 151.964(1) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | f | | IUPAC |
...
Europium (Eu, Z = 63) is a lanthanide in period 6, group 3 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f7** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 151.964(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f7 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | UNAVAILABLE | Pauling | See source | UNAVAILABLE | UNAVAILABLE |
| firstIonizationEnergy | 5.67 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1095 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1802 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 5.24 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
