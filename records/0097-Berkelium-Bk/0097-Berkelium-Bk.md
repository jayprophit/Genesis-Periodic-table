...
|---|---|---|---|
| Canonical name | Berkelium | | IUPAC |
| Symbol | Bk | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 97 | | IUPAC |
...
Berkelium (Bk, Z = 97) is a actinide in period 7, group 3 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f9** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f9 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.3 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.23 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1323 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | UNAVAILABLE | K | See source | UNAVAILABLE | UNAVAILABLE |
| density | 14 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
