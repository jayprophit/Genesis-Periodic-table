...
|---|---|---|---|
| Canonical name | Seaborgium | | IUPAC |
| Symbol | Sg | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 106 | | IUPAC |
...
Seaborgium (Sg, Z = 106) is a transition metal in period 7, group 6 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d4** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d4 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
...
| oxidationStates | 6, 5, 4, 3, 0 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
