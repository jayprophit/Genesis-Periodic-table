...
|---|---|---|---|
| Canonical name | Meitnerium | | IUPAC |
| Symbol | Mt | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 109 | | IUPAC |
...
Meitnerium (Mt, Z = 109) is a transition metal in period 7, group 9 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d7 (calculated)** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d7 (calculated) | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
...
| oxidationStates | 9, 8, 6, 4, 3, 1 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
