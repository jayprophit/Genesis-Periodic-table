...
|---|---|---|---|
| Canonical name | Chromium | | IUPAC |
| Symbol | Cr | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 24 | | IUPAC |
| Standard atomic weight | 51.9961(6) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 6 | | IUPAC |
| Block | d | | IUPAC |
...
Chromium (Cr, Z = 24) is a transition metal in period 4, group 6 of the periodic table.
...
Electronic configuration: **[Ar]3d5 4s1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 51.9961(6) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]3d5 4s1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.66 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.767 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2180 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 2944 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 7.15 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +6, +3, +2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
