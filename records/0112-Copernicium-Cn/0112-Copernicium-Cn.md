...
|---|---|---|---|
| Canonical name | Copernicium | | IUPAC |
| Symbol | Cn | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 112 | | IUPAC |
...
Copernicium (Cn, Z = 112) is a transition metal in period 7, group 12 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d10 (predicted)** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d10 (predicted) | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
...
| oxidationStates | 2, 1, 0 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
