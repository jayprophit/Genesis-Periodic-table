...
|---|---|---|---|
| Canonical name | Silicon | | IUPAC |
| Symbol | Si | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 14 | | IUPAC |
| Standard atomic weight | [28.084,28.086] | EVALUATED | CIAAW-2024 |
| Period | 3 | | IUPAC |
| Group | 14 | | IUPAC |
| Block | p | | IUPAC |
...
Silicon (Si, Z = 14) is a metalloid in period 3, group 14 of the periodic table.
...
Electronic configuration: **[Ne]3s2 3p2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | [28.084,28.086] | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ne]3s2 3p2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.9 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 8.152 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1687 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3538 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 2.3296 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +4, +2, -4 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
