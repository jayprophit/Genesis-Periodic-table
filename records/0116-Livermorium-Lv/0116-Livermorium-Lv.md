...
| Standard atomic weight | 293 | | IUPAC |
| Period | 7 | | IUPAC |
| Group | 16 | | IUPAC |
| Block | p | | IUPAC |
...
|---|---:|---|---|---|---|
| Atomic weight | 293 | u | STP | MEASURED | IUPAC |
| First ionization energy | UNKNOWN | | | MEASURED | NIST ASD |
| Electronegativity | UNKNOWN | | | MEASURED | Pauling Scale |
