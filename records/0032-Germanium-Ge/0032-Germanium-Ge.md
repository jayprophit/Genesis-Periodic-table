...
|---|---|---|---|
| Canonical name | Germanium | | IUPAC |
| Symbol | Ge | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 32 | | IUPAC |
| Standard atomic weight | 72.630(8) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 14 | | IUPAC |
| Block | p | | IUPAC |
...
Germanium (Ge, Z = 32) is a metalloid in period 4, group 14 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d10 4p2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 72.630(8) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d10 4p2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.01 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.9 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1211.4 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3106 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 5.323 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
