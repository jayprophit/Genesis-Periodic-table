...
|---|---|---|---|
| Canonical name | Barium | | IUPAC |
| Symbol | Ba | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 56 | | IUPAC |
| Standard atomic weight | 137.327(7) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 2 | | IUPAC |
| Block | s | | IUPAC |
...
Barium (Ba, Z = 56) is a alkaline earth metal in period 6, group 2 of the periodic table.
...
Electronic configuration: **[Xe]6s2** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 137.327(7) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 0.89 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 5.212 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1000 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 2170 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 3.62 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
