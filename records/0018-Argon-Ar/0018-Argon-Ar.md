...
|---|---|---|---|
| Canonical name | Argon | | IUPAC |
| Symbol | Ar | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 18 | | IUPAC |
| Standard atomic weight | [39.792,39.963] | EVALUATED | CIAAW-2024 |
| Period | 3 | | IUPAC |
| Group | 18 | | IUPAC |
| Block | p | | IUPAC |
...
Argon (Ar, Z = 18) is a noble gas in period 3, group 18 of the periodic table.
...
Electronic configuration: **[Ne]3s2 3p6** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | [39.792,39.963] | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ne]3s2 3p6 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | UNAVAILABLE | Pauling | See source | UNAVAILABLE | UNAVAILABLE |
| firstIonizationEnergy | 15.76 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Gas | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 83.8 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 87.3 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 0.0017837 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
