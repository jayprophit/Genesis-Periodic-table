...
|---|---|---|---|
| Canonical name | Cobalt | | IUPAC |
| Symbol | Co | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 27 | | IUPAC |
| Standard atomic weight | 58.933194(3) | EVALUATED | CIAAW-2024 |
| Period | 4 | | IUPAC |
| Group | 9 | | IUPAC |
| Block | d | | IUPAC |
...
Cobalt (Co, Z = 27) is a transition metal in period 4, group 9 of the periodic table.
...
Electronic configuration: **[Ar]4s2 3d7** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 58.933194(3) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ar]4s2 3d7 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.88 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.881 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1768 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3200 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 8.86 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
