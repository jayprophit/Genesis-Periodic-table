...
|---|---|---|---|
| Canonical name | Bohrium | | IUPAC |
| Symbol | Bh | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 107 | | IUPAC |
...
Bohrium (Bh, Z = 107) is a transition metal in period 7, group 7 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d5** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d5 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
...
| oxidationStates | 7, 5, 4, 3 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
