...
|---|---|---|---|
| Canonical name | Cerium | | IUPAC |
| Symbol | Ce | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 58 | | IUPAC |
| Standard atomic weight | 140.116(1) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | f | | IUPAC |
...
Cerium (Ce, Z = 58) is a lanthanide in period 6, group 3 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f1 5d1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 140.116(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f1 5d1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.12 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 5.539 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1071 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3697 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 6.77 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
