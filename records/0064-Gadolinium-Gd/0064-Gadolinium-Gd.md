...
|---|---|---|---|
| Canonical name | Gadolinium | | IUPAC |
| Symbol | Gd | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 64 | | IUPAC |
| Standard atomic weight | 157.249(2) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 3 | | IUPAC |
| Block | f | | IUPAC |
...
Gadolinium (Gd, Z = 64) is a lanthanide in period 6, group 3 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f7 5d1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 157.249(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f7 5d1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.2 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 6.15 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 1586 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 3546 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 7.9 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
