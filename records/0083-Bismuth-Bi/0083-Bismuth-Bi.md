...
|---|---|---|---|
| Canonical name | Bismuth | | IUPAC |
| Symbol | Bi | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 83 | | IUPAC |
| Standard atomic weight | 208.98040(1) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 15 | | IUPAC |
| Block | p | | IUPAC |
...
Bismuth (Bi, Z = 83) is a post-transition metal in period 6, group 15 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d10 6p3** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 208.98040(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d10 6p3 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.02 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.289 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 544.55 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1837 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 9.807 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +5, +3 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
