...
|---|---|---|---|
| Canonical name | Antimony | | IUPAC |
| Symbol | Sb | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 51 | | IUPAC |
| Standard atomic weight | 121.760(1) | EVALUATED | CIAAW-2024 |
| Period | 5 | | IUPAC |
| Group | 15 | | IUPAC |
| Block | p | | IUPAC |
...
Antimony (Sb, Z = 51) is a metalloid in period 5, group 15 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d10 5p3** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 121.760(1) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Kr]5s2 4d10 5p3 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.05 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 8.64 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 903.78 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1860 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 6.685 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
