...
|---|---|---|---|
| Canonical name | Darmstadtium | | IUPAC |
| Symbol | Ds | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 110 | | IUPAC |
...
Darmstadtium (Ds, Z = 110) is a transition metal in period 7, group 10 of the periodic table.
...
Electronic configuration: **[Rn]7s2 5f14 6d8 (predicted)** (PREDICTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Rn]7s2 5f14 6d8 (predicted) | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
...
| oxidationStates | 8, 6, 4, 2, 0 | dimensionless / text | See source | PREDICTED | PUBCHEM-PERIODIC |
