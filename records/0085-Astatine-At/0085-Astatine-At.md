...
|---|---|---|---|
| Canonical name | Astatine | | IUPAC |
| Symbol | At | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 85 | | IUPAC |
...
Astatine (At, Z = 85) is a halogen in period 6, group 17 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d10 6p5** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Xe]6s2 4f14 5d10 6p5 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.2 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 9.5 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 575 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | UNAVAILABLE | K | See source | UNAVAILABLE | UNAVAILABLE |
| density | 7 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | 7, 5, 3, 1, -1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
