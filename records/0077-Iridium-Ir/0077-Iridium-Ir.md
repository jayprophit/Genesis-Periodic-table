...
|---|---|---|---|
| Canonical name | Iridium | | IUPAC |
| Symbol | Ir | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 77 | | IUPAC |
| Standard atomic weight | 192.217(2) | EVALUATED | CIAAW-2024 |
| Period | 6 | | IUPAC |
| Group | 9 | | IUPAC |
| Block | d | | IUPAC |
...
Iridium (Ir, Z = 77) is a transition metal in period 6, group 9 of the periodic table.
...
Electronic configuration: **[Xe]6s2 4f14 5d7** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 192.217(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Xe]6s2 4f14 5d7 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 2.2 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 9.1 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2719 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 4701 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 22.42 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +4, +3 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
