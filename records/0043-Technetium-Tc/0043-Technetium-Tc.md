...
|---|---|---|---|
| Canonical name | Technetium | | IUPAC |
| Symbol | Tc | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 43 | | IUPAC |
...
Technetium (Tc, Z = 43) is a transition metal in period 5, group 7 of the periodic table.
...
Electronic configuration: **[Kr]5s2 4d5** (REPORTED; PUBCHEM-PERIODIC).
...
| electronConfiguration | [Kr]5s2 4d5 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 1.9 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 7.28 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 2430 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 4538 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 11 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
| oxidationStates | +7, +6, +4 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
