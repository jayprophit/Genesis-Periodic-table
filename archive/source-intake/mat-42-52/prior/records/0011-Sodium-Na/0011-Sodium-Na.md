...
|---|---|---|---|
| Canonical name | Sodium | | IUPAC |
| Symbol | Na | | IUPAC |
| Record class | CHEMICAL_ELEMENT | | MAT |
| Atomic number | 11 | | IUPAC |
| Standard atomic weight | 22.98976928(2) | EVALUATED | CIAAW-2024 |
| Period | 3 | | IUPAC |
| Group | 1 | | IUPAC |
| Block | s | | IUPAC |
...
Sodium (Na, Z = 11) is a alkali metal in period 3, group 1 of the periodic table.
...
Electronic configuration: **[Ne]3s1** (REPORTED; PUBCHEM-PERIODIC).
...
|---|---|---|---|---|---|
| atomicWeight | 22.98976928(2) | dimensionless / text | See source | EVALUATED | CIAAW-2024 |
| electronConfiguration | [Ne]3s1 | dimensionless / text | See source | REPORTED | PUBCHEM-PERIODIC |
| electronegativity | 0.93 | Pauling | See source | REPORTED | PUBCHEM-PERIODIC |
| firstIonizationEnergy | 5.139 | eV | See source | REPORTED | PUBCHEM-PERIODIC |
| phase | Solid | dimensionless / text | Source standard state; verify temperature and pressure for reuse | REPORTED | PUBCHEM-PERIODIC |
| meltingPoint | 370.95 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| boilingPoint | 1156 | K | See source | REPORTED | PUBCHEM-PERIODIC |
| density | 0.97 | g/cm3 | Source reference conditions; consult element page | REPORTED | PUBCHEM-PERIODIC |
